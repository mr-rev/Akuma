...
import tar_put._util.win32_vks as VK

from tar_put._util import AbstractListener
from tar_put._util.win32 import (
    INPUT,
    INPUT_union,
    KEYBDINPUT,
    KeyTranslator,
...
class As1d(ListenerMixin, _base.As1d):
    _EVENTS = 13
    ...
    def __init__(self, *args, **kwargs):
        super(As1d, self).__init__(*args, **kwargs)
    ...
    def canonical(self, key):
        ...
        return super(As1d, self).canonical(key)
